...
let
    ...
    cudacall(dummy, Tuple{}; threads=1, blocks=1, shmem=0, cooperative=false)
    cudacall(dummy, ())
    cudacall(dummy, (); threads=1, blocks=1, shmem=0, cooperative=false)
    ...
    CUDA.launch(dummy; threads=1, blocks=1, shmem=0, cooperative=false)
end
